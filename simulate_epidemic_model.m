...
disp(s)
    feature('jit','off')
    feature('accel', 'off')
    [Y_real,defGDP,debGDP,labforce1,labforce2,Lev_a,Lev_ab,Lev_al,Lev_af,Lev_ak,defaults,defaults_k,Hdemand,CPI_b,CPI_l,dprob,lock_duration,detect_new,inf_detected,distance,inf_share2,sus_share2,rec_share2,healthcare,serious_share,inf_cum,inf_new,sus_share,inf_share,rec_share,dead_share,gdp_deflator, Investment,EXP, consumption, Un,stock_bonds,wages_t, desired_consumption, totK,I,totE,bankruptcy_rate,et] = model_epidemic(s,T, param);
